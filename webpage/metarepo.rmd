...
```{r, echo=FALSE, out.width="80%", fig.align='center', fig.cap="**Comparison of GCAM outputs global runoff for 5 GCMS **"}
knitr::include_graphics("images/chart_param_all_summary.png")
```
...
```{r, echo=FALSE, out.width="90%", fig.align='center', fig.cap="**Comparison of GCAM socioeconomic outputs for 5 GCMS **"}
knitr::include_graphics("images/chart_param_diff_percent_socioecon.png")
```
...
```{r, echo=FALSE, out.width="130%", fig.align='center', fig.cap="**Comparison of GCAM water outputs for 5 GCMS **"}
knitr::include_graphics("images/chart_class_diff_absolute_water.png")
```
...
```{r, echo=FALSE, out.width="130%", fig.align='center', fig.cap="**Comparison of GCAM electricity outputs for 5 GCMS **"}
knitr::include_graphics("images/chart_class_diff_absolute_energy.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Comparison of GCAM AGLU outputs for 5 GCMS **"}
knitr::include_graphics("images/chart_class_diff_absolute_aglu.png")
```
...
knitr::include_graphics("images/compareCO2GlobalCumRCP.png")
```

<br>

```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Comparison of GCAM emissions outputs for 5 GCMS **"}
knitr::include_graphics("images/compareCO2USA.png")
```

<br>

```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Comparison of GCAM emissions outputs for 5 GCMS **"}
knitr::include_graphics("images/compareNonCO2global.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align='center', fig.cap="**Comparison of GCAM outputs global runoff for NORESM different smoothing techniques **"}
knitr::include_graphics("images/chart_param_all_summary_smooth.png")
```
...
```{r, echo=FALSE, out.width="90%", fig.align='center', fig.cap="**Comparison of GCAM socioeconomic outputs for NORESM different smoothing techniques **"}
knitr::include_graphics("images/chart_param_diff_percent_socioecon_smooth.png")
```
...
<br>
```{r, echo=FALSE, out.width="130%", fig.align='center', fig.cap="**Comparison of GCAM water outputs for NORESM different smoothing techniques **"}
knitr::include_graphics("images/chart_class_diff_absolute_water_smooth.png")
```
...
```{r, echo=FALSE, out.width="130%", fig.align='center', fig.cap="**Comparison of GCAM electricity outputs for NORESM different smoothing techniques **"}
knitr::include_graphics("images/chart_class_diff_absolute_energy_smooth.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Comparison of GCAM AGLU outputs for NORESM different smoothing techniques **"}
knitr::include_graphics("images/chart_class_diff_absolute_aglu_smooth.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Comparison of GCAM emissions outputs for NORESM different smoothing techniques **"}
knitr::include_graphics("images/compareCO2GlobalCumRCP_smooth.png")
```

<br>

```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Comparison of GCAM emissions outputs for NORESM different smoothing techniques **"}
knitr::include_graphics("images/compareCO2USA_smooth.png")
```

<br>

```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Comparison of GCAM emissions outputs for NORESM different smoothing techniques **"}
knitr::include_graphics("images/compareNonCO2global_smooth.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align='center', fig.cap="**Comparison of GCAM outputs global runoff for SSP3 and SSP5 **"}
knitr::include_graphics("images/chart_param_all_summary_ssp35.png")
```
...
```{r, echo=FALSE, out.width="90%", fig.align='center', fig.cap="**Comparison of GCAM socioeconomic outputs for SSP3 and SSP5 **"}
knitr::include_graphics("images/chart_param_diff_percent_socioecon_ssp35.png")
```
...
<br>
```{r, echo=FALSE, out.width="130%", fig.align='center', fig.cap="**Comparison of GCAM water outputs for SSP3 and SSP5 **"}
knitr::include_graphics("images/chart_class_diff_absolute_water_ssp35.png")
```
...
```{r, echo=FALSE, out.width="130%", fig.align='center', fig.cap="**Comparison of GCAM electricity outputs for SSP3 and SSP5 **"}
knitr::include_graphics("images/chart_class_diff_absolute_energy_ssp35.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Comparison of GCAM AGLU outputs for SSP3 and SSP5 **"}
knitr::include_graphics("images/chart_class_diff_absolute_aglu_ssp35.png")
```
