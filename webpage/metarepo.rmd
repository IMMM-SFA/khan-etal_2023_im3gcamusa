...
```{r, echo=FALSE, out.width="200%", fig.align='center', fig.cap="**Comparison of State-level Superpeak Electricity Load (GW) for 4 climate and socioeconomic scenarios. **"}
knitr::include_graphics("images/Superpeak Electricity Load (GW).png")
```
