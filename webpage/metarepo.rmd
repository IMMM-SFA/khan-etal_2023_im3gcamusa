...
```{r, echo=FALSE, out.width="150%", fig.align='center', fig.cap="**Comparison of GCAM outputs global runoff for Smoothing. **"}
...
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Comparison of GCAM emissions outputs for Smoothing. **"}
...
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Smoothing diagnostics for selected US Basins for rcp85hotter_ssp5. Water runoff values are in km^3^.**"}
...
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Delta processing diagnostics for selected US Basins for rcp85hotter_ssp5. Water runoff values are in km^3^.**"}
...
#### Maps of global water runoff 

<br>

```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Comparison of global water runoff in 2100 (km^3^) under RCP8.5 hotter and RCP8.5 cooler**"}
knitr::include_graphics("images/map_param_2100_KMEANS.png")
```


```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Absolute difference of global water runoff in 2100 (km^3^) between RCP8.5 hotter and RCP8.5 cooler**"}
knitr::include_graphics("images/map_param_2100_KMEANS_DiffAbs.png")
```

```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Relative difference of global water runoff (%) in 2100 between RCP8.5 hotter and RCP8.5 cooler.**"}
...
<!-- I forget, what are we comparing in this section again?
-->
#### Summary

<br>

```{r, echo=FALSE, out.width="150%", fig.align='center', fig.cap="**Comparison of GCAM summary outputs.**"}
