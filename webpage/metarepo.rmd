...
```{r, echo=FALSE, out.width="130%", fig.align='center', fig.cap="**Comparison of GCAM energy outputs for 5 GCMS **"}
...
```{r, echo=FALSE, out.width="90%", fig.align='center', fig.cap="**Comparison of GCAM emissions outputs for 5 GCMS **"}
knitr::include_graphics("images/compareCO2GlobalCumRCP_GCMs_5trail_delta.png")
```

<br>

```{r, echo=FALSE, out.width="80%", fig.align='center', fig.cap="**Comparison of GCAM emissions outputs for 5 GCMS **"}
...
```{r, echo=FALSE, out.width="130%", fig.align='center', fig.cap="**Comparison of GCAM energy outputs for NORESM different smoothing techniques **"}
...
knitr::include_graphics("images/chart_class_diff_absolute_electricity_runoff_NORESM_smooth_delta.png")
```

<br>

```{r, echo=FALSE, out.width="130%", fig.align='center', fig.cap="**Comparison of GCAM electricity outputs for NORESM different smoothing techniques **"}
knitr::include_graphics("images/chart_class_diff_percent_electricity_runoff_NORESM_smooth_delta.png")
```
...
```{r, echo=FALSE, out.width="90%", fig.align='center', fig.cap="**Comparison of GCAM emissions outputs for NORESM different smoothing techniques **"}
knitr::include_graphics("images/compareCO2GlobalCumRCP_smooth_delta.png")
```

<br>

```{r, echo=FALSE, out.width="80%", fig.align='center', fig.cap="**Comparison of GCAM emissions outputs for NORESM different smoothing techniques **"}
...
```{r, echo=FALSE, out.width="130%", fig.align='center', fig.cap="**Comparison of GCAM energy outputs for SSP3 and SSP5 **"}
...
```{r, echo=FALSE, out.width="90%", fig.align='center', fig.cap="**Comparison of GCAM emission outputs for SSP3 and SSP5 **"}
