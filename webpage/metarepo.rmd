...
```{r, echo=FALSE, out.width="200%", fig.align='center', fig.cap="**Comparison of GCAM energy outputs for 4 climate and socioeconomic scenarios (absolute diference). **"}
...
```{r, echo=FALSE, out.width="200%", fig.align='center', fig.cap="**Comparison of GCAM electricity outputs for 4 climate and socioeconomic scenarios (absolute diference). **"}
...
```{r, echo=FALSE, out.width="200%", fig.align='center', fig.cap="**Comparison of GCAM AGLU outputs for 4 climate and socioeconomic scenarios (absolute diference). **"}
...
```{r, echo=FALSE, out.width="200%", fig.align='center', fig.cap="**Comparison of global cumulative CO2 emissions for 4 climate and socioeconomic scenarios (percent difference). **"}
knitr::include_graphics("images/compareCO2GlobalCumRCP_im3.png")
```

<br>

```{r, echo=FALSE, out.width="200%", fig.align='center', fig.cap="**Comparison of USA CO2 emissions for 4 climate and socioeconomic scenarios (percent difference). **"}
knitr::include_graphics("images/compareCO2USA_im3.png")
```

<br>

```{r, echo=FALSE, out.width="200%", fig.align='center', fig.cap="**Comparison of global non-CO2 emissions for 4 climate and socioeconomic scenarios (percent difference). **"}
knitr::include_graphics("images/compareNonCO2global_im3.png")
```

<br>

```{r, echo=FALSE, out.width="200%", fig.align='center', fig.cap="**Comparison of USA non-CO2 emissions for 4 climate and socioeconomic scenarios (percent difference). **"}
