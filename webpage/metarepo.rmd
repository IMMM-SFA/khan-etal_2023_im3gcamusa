...
For RCP4.5, we impose a global CO~2~ emissions constraint. This emissions constraint in turn is based on the GCAM core model, version 5.4, a global model differentiating 32 world regions. 
Specifically, we run GCAM release version 5.4 in target finder mode.
...
Figure xx illustrates the final CO~2~ pathway, as well as the corresponding CO~2~-price pathway and the forcing:
