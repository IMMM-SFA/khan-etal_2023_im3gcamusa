...
knitr::include_graphics("images/chart_param_all_summary_GCMs_5trail_delta.png")
```
...
knitr::include_graphics("images/chart_param_absolute_socioecon_GCMs_5trail_delta.png")
```
...
knitr::include_graphics("images/chart_class_diff_absolute_water_GCMs_5trail_delta.png")
```
...
knitr::include_graphics("images/chart_class_diff_absolute_energy_GCMs_5trail_delta.png")
```
...
knitr::include_graphics("images/chart_class_diff_absolute_aglu_GCMs_5trail_delta.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align='center', fig.cap="**Comparison of GCAM outputs global runoff for 5 GCMS **"}
knitr::include_graphics("images/chart_param_all_summary_NORESM_smooth_delta.png")
```
...
```{r, echo=FALSE, out.width="90%", fig.align='center', fig.cap="**Comparison of GCAM socioeconomic outputs for 5 GCMS **"}
knitr::include_graphics("images/chart_param_absolute_socioecon_NORESM_smooth_delta.png")
```
...
```{r, echo=FALSE, out.width="130%", fig.align='center', fig.cap="**Comparison of GCAM water outputs for 5 GCMS **"}
knitr::include_graphics("images/chart_class_diff_absolute_water_NORESM_smooth_delta.png")
```
...
```{r, echo=FALSE, out.width="130%", fig.align='center', fig.cap="**Comparison of GCAM electricity outputs for 5 GCMS **"}
knitr::include_graphics("images/chart_class_diff_absolute_energy_NORESM_smooth_delta.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Comparison of GCAM AGLU outputs for 5 GCMS **"}
knitr::include_graphics("images/chart_class_diff_absolute_aglu_NORESM_smooth_delta.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Comparison of GCAM emissions outputs for 5 GCMS **"}
knitr::include_graphics("images/compareCO2GlobalCumRCP_NORESM_smooth_delta.png")
```

<br>

```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Comparison of GCAM emissions outputs for 5 GCMS **"}
knitr::include_graphics("images/compareCO2USA_NORESM_smooth_delta.png")
```

<br>

```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Comparison of GCAM emissions outputs for 5 GCMS **"}
knitr::include_graphics("images/compareNonCO2global_NORESM_smooth_delta.png")
```

<br>

```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Comparison of GCAM emissions outputs for 5 GCMS **"}
knitr::include_graphics("images/compareNonCO2USA_NORESM_smooth_delta.png")
```
...
```{r, echo=FALSE, out.width="90%", fig.align='center', fig.cap="**Comparison of GCAM socioeconomic outputs for 5 GCMS **"}
knitr::include_graphics("images/chart_param_absolute_socioecon_im3_runoff.png")
```
