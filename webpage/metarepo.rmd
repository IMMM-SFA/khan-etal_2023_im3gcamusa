...
knitr::include_graphics("images/compare_GCAM_global_GCMs_5trail.png")
```
...
knitr::include_graphics("images/compare_GCAM_global_noresm_smooth.png")
```
...
### GCAM rcp85hotter_ssp5 {.tabset .tabset-pills}
