...
knitr::include_graphics("images/hdcd_diagnostic_allYears_freeScalercp85cooler_ssp3.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Heating and cooling degree-hours by GCAM-USA segments from 2020 - 2100 at 5-year interval.**"}
knitr::include_graphics("images/hdcd_diagnostic_allYears_freeScalercp85cooler_ssp5.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Heating and cooling degree-hours by GCAM-USA segments from 2020 - 2100 at 5-year interval.**"}
knitr::include_graphics("images/hdcd_diagnostic_allYears_freeScalercp85hotter_ssp3.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Heating and cooling degree-hours by GCAM-USA segments from 2020 - 2100 at 5-year interval.**"}
knitr::include_graphics("images/hdcd_diagnostic_allYears_freeScalercp85hotter_ssp5.png")
```
