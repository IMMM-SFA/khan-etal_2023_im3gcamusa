...
Khan, Z., Wolfram, P., Iyer, G., Rice, J., Vernon, C., Binsted, M., Graham, N. 2022. Coevolution of future water, energy and land systems across the United States in response to national and global socioeconomic, climate, and energy policy drivers. (In-Prep) Journal_TBD, DOI: XXXX
...
knitr::include_graphics("vignetteFigs/water_runoff_GCM_8p5_raw_10ysurr_delta2015_clip.png")
```

```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Comparison of GCAM outputs global runoff for 5 GCMS **"}
knitr::include_graphics("vignetteFigs/compare_GCAM_global_GCMs_5trail.png")
```

```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Comparison of GCAM outputs global runoff for different smoothing methods for GCM NORESM **"}
knitr::include_graphics("vignetteFigs/compare_GCAM_global_noresm_smooth.png")
```
...
mytable = data.frame(
    Step     = c("Workflow 1A Outputs",
                 ...
                 "Smoothing",
                 "Convert to XML",
                 "Run GCAM scenario rcp85hotter_ssp5"),
    Description = c("Runoff mm per month for US Basins.",
                 ...
                 "* Run GCAM using rcp85hotter_ssp5 runoff."),
    Location     = c("* /pic/projects/im3/gcamusa/climateimpacts/runoff/outputs_workflow1a\
                 ...
                 \n * configuration_rcp85hotter_ssp5.xml")
    )
...
knitr::include_graphics("vignetteFigs/wrf_xanthos_compare_us_default.png")
```

```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Smoothing diagnostics for selected US Basins for rcp85hotter_ssp5**"}
knitr::include_graphics("vignetteFigs/Basin_runoff_km3peryear_comb_ssp585_rcp85_noresm_1979_2100_window5trail_1.png")
```
...
knitr::include_graphics("vignetteFigs/Basin_runoff_km3peryear_comb_ssp585_rcp85_noresm_1979_2100_window5trail_delta2015_1.png")
```

** GCAM Diagnostics for rcp85hotter_ssp5 with runoff impacts**: In Progress.
...
### **Table: Workflow 6 - Final GCAM-USA Runs**
...
### **Table: Workflow 6 - Intermediate GCAM-USA Run Diagnostics**
