...
* Compare outputs from the NORESM global climate model smoothed over 5- and 10-year windows using trailing and surrounding years

<br>
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.cap="**Comparison of smoothed runoff data from the NORESM model **"}
knitr::include_graphics("vignetteFigs/water_runoff_facet_window_type.png")
```
<br>
